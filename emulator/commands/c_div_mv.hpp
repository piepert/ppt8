...
public:
    ...
    int run(std::vector<uint8_t> args, Runtime* runtime) override // COMMAND
    {
        ...
        runtime->getFX()->setValueComplete16bit(runtime->getMemory()->get16bitValueFromAddress(ppt8_std::combine_8bit_to_16bit(args[0], args[1])) % args[2]);
        return 0;
    }
};
